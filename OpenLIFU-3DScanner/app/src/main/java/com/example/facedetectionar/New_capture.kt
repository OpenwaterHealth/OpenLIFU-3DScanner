    ...
    private fun makeRingConfigJsonFile() {
        ...
        try {
            ...
            val arrowCoordinatesArray = JSONArray().apply {
                // Second set (original IDs 30-49)
                put(JSONObject().apply {
                    put("seqID", 0)
                    put("xPoint", -0.056312673)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.22314285)
                    put("verticalAngle", 35)
                    put("horizontalAngle", 0)
                })
                put(JSONObject().apply {
                    put("seqID", 1)
                    put("xPoint", -0.11811607)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.23293154)
                    put("verticalAngle", 45)
                    put("horizontalAngle", 18)
                })
                put(JSONObject().apply {
                    put("seqID", 2)
                    put("xPoint", -0.17386973)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.26133946)
                    put("verticalAngle",37)
                    put("horizontalAngle", 36)
                })
                put(JSONObject().apply {
                    put("seqID", 3)
                    put("xPoint", -0.21811607)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.3055858)
                    put("verticalAngle", 48)
                    put("horizontalAngle", 54)
                })
                put(JSONObject().apply {
                    put("seqID", 4)
                    put("xPoint", -0.24652398)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.36133945)
                    put("verticalAngle", 44)
                    put("horizontalAngle", 72)
                })
                put(JSONObject().apply {
                    put("seqID", 5)
                    put("xPoint", -0.25631267)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.42314285)
                ...
                put(JSONObject().apply {
                    ...
                    put("xPoint", -0.056312673)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.62314284)
                    put("verticalAngle", 10)
                    put("horizontalAngle", 180)
                })
                put(JSONObject().apply {
                    put("seqID", 11)
                    put("xPoint", 0.0054907277)
                    put("yPoint", 0.030656703)
                    put("zPoint", -0.61335415)
