        ...
        try {
            ...
            val arrowCoordinatesArray = JSONArray().apply {
                put(JSONObject().apply {
                    put("seqID", 0)
                    put("xPoint", -0.07631267)
                    put("yPoint", 0.2106567)
                    put("zPoint", 0.3481966)
                    put("verticalAngle", 30)
                    put("horizontalAngle", 0)
                })
                put(JSONObject().apply {
                    put("seqID", 1)
                    put("xPoint", -0.13811607)
                    put("yPoint", 0.2106567)
                    put("zPoint", 0.3384079)
                    put("verticalAngle", 26)
                    put("horizontalAngle", 18)
                })
                put(JSONObject().apply {
                    put("seqID", 2)
                    put("xPoint", -0.19386973)
                    put("yPoint", 0.2106567)
                    put("zPoint", 0.31)
                ...
                put(JSONObject().apply {
                    put("seqID", 3)
                    put("xPoint", -0.23811606)
                    put("yPoint", 0.2106567)
                    put("zPoint", 0.26575366)
                    put("verticalAngle", 24)
                    put("horizontalAngle", 54)
                })
                put(JSONObject().apply {
                    put("seqID", 4)
                    put("xPoint", -0.26652398)
                    put("yPoint", 0.2106567)
                    put("zPoint", 0.21)
                ...
                put(JSONObject().apply {
                    put("seqID", 5)
                    put("xPoint", -0.27631267)
                    put("yPoint", 0.2106567)
                    put("zPoint", 0.14819661)
                ...
                put(JSONObject().apply {
                    ...
                    put("xPoint", -0.07631267)
                    put("yPoint", 0.2106567)
                    put("zPoint", -0.05180338)
                    put("verticalAngle", 10)
                    put("horizontalAngle", 180)
                })
                put(JSONObject().apply {
                    put("seqID", 11)
                    put("xPoint", -0.014509272)
                    put("yPoint", 0.2106567)
                    put("zPoint", -0.04201469)
                    put("verticalAngle", 30)
